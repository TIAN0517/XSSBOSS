...
$config['dbUser']		='xssuser';				//用户
$config['dbPwd']		='Ss520520';				//密码
$config['database']		='xss_platform';			//数据库名
$config['charset']		='utf8';				//数据库字符集
$config['tbPrefix']		='oc_';					//表名前缀
$config['dbType']		='mysql';				//数据库类型(目前只支持mysql)

/* 注册配置 */
$config['register']		='close';				//normal,正常;invite,只允许邀请注册;close,关闭注册功能
$config['mailauth']		=false;					//注册时是否邮箱验证

/* url配置 */
$config['urlroot']		='https://xss.bossjy.ccwu.cc';	//访问的url起始  注意结尾没有/
